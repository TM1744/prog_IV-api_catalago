...
namespace umfgcloud.loja.dominio.service.DTO
{
    public sealed class UsuarioDTO
    {
        public abstract class AbstractUsuario
        {
            ...
            [EmailAddress(ErrorMessage = "O atributo email é inválido")]
            ...
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
            [StringLength(50, ErrorMessage = "O atributo password deve ter entre 6 e 50 caracteres", MinimumLength = 6)]
